...
if vim.o.background == "dark" then
    ...
    vim.g.terminal_color_1 = "#cd5c81"
    vim.g.terminal_color_2 = "#5ebdab"
    vim.g.terminal_color_3 = "#fea44c"
    vim.g.terminal_color_4 = "#2777ff"
    vim.g.terminal_color_5 = "#962ac3"
    vim.g.terminal_color_6 = "#49aee6"
    vim.g.terminal_color_7 = "#dddddd"
    vim.g.terminal_color_8 = "#626262"
    vim.g.terminal_color_9 = "#ff0000"
    vim.g.terminal_color_10 = "#00ff33"
    vim.g.terminal_color_11 = "#edce94"
    vim.g.terminal_color_12 = "#05a1f7"
    vim.g.terminal_color_13 = "#9755b3"
    vim.g.terminal_color_14 = "#82e1e4"
    ...
    local def_fg = fg
    local const_fg = "#9755b3"
    local active = "#edce94"
    local string_fg = "#9755b3"
    ...
    theme = {
        ...
        SpellBad = { undercurl = 1, sp = ansi.lightred },
        ...
        Identifier = { fg = fg },
        Function = { fg = def_fg },
        Statement = { fg = ansi.lightgreen, bold=1},
        Conditional = { fg = ansi.lightgreen, bold=1 },
        Repeat = { fg = ansi.lightgreen, bold=1 },
        Label = { fg = ansi.lightgreen },
        Keyword = { fg = ansi.lightgreen },
        ...
        ["@keyword"] = { fg = ansi.lightgreen },
        ["@keyword.function"] = { fg = ansi.lightgreen },
        ["@label"] = { fg = ansi.white },
